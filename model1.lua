...
function library:createwindow(title)
    ...
    settings:adddropdown("Toggle Key",{"LeftAlt","RightAlt","Insert","F4"},function(v)
        library.toggleKey=Enum.KeyCode[v]
    end)
    settings:addbutton("Save Config",function() saveConfig("default") end)
    settings:addbutton("Load Config",function() loadConfig("default") end)
